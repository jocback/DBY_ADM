...
b.onerror=function(){b=null;loading_image_show(!1);c("[FAIL]File Upload Error")};var d=new FormData;a.formData&&0<a.formData.length&&a.formData.each(function(a,b){"proxy_url"==a&&(b="0"!=DEXTTOP.G_CURREDITOR._config.security.encryptParam?DEXTTOP.DEXT5.util.makeEncryptParamFinal(""):"");d.append(a,b)});a.fileObj&&d.append(a.fileID,a.fileObj[0]);b.open("POST",a.handlerUrl,!0);b.send(d)}
function uploadAjaxOnprogressCancel(){if(DEXTTOP.G_CURREDITOR.xhr_onprogress)try{DEXTTOP.G_CURREDITOR.xhr_onprogress.abort(),DEXTTOP.G_CURREDITOR.xhr_onprogress=null}catch(a){}}
