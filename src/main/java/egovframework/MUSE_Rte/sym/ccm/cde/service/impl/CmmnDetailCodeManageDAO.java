package egovframework.MUSE_Rte.sym.ccm.cde.service.impl;
...
public class CmmnDetailCodeManageDAO extends EgovComAbstractDAO {
	...
	public CmmnDetailCode selectCmmnDetailCodeDetail(CmmnDetailCode cmmnDetailCode) throws Exception {
		return (CmmnDetailCode) selectOne("CmmnDetailCodeManage.selectCmmnDetailCodeDetail", cmmnDetailCode);
	}
     ...
     * @throws Exception
     */
    public List<?> selectCmmnDetailCodeList(CmmnCodeVO searchVO) throws Exception {
        String DaoQuary = "CmmnDetailCodeManage.selectCmmnDetailCodeList";
        if(searchVO.getSearchGubun().equals("view")){
        	DaoQuary = "CmmnDetailCodeManage.selectCmmnDetailCodeView";
        }
    	return selectList(DaoQuary, searchVO);
    }
     ...
     */
    public int selectCmmnDetailCodeListTotCnt(CmmnCodeVO searchVO) throws Exception {
	...
	public void updateCmmnDetailCode(CmmnDetailCode cmmnDetailCode) throws Exception {
		update("CmmnDetailCodeManage.updateCmmnDetailCode", cmmnDetailCode);
	}
