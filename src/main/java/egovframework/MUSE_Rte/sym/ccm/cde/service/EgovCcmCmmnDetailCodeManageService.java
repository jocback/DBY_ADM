package egovframework.MUSE_Rte.sym.ccm.cde.service;
...
public interface EgovCcmCmmnDetailCodeManageService {
	 ...
	 * @throws Exception
	 */
	List<?> selectCmmnDetailCodeList(CmmnCodeVO searchVO) throws Exception;
     ...
     */
    int selectCmmnDetailCodeListTotCnt(CmmnCodeVO searchVO) throws Exception;
