...
package egovframework.MUSE_Rte.uat.uap.service.impl;

import java.util.List;

import egovframework.com.cmm.service.impl.EgovComAbstractDAO;
import egovframework.MUSE_Rte.uat.uap.service.LoginPolicy;
import egovframework.MUSE_Rte.uat.uap.service.LoginPolicyVO;
...
public class LoginPolicyDAO extends EgovComAbstractDAO {
	...
	public List<LoginPolicyVO> selectLoginPolicyList(LoginPolicyVO loginPolicyVO) throws Exception {
		return selectList("LoginPolicy.selectLoginPolicyList", loginPolicyVO);
	}
	...
	public int selectLoginPolicyListTotCnt(LoginPolicyVO loginPolicyVO) throws Exception {
		return (Integer)selectOne("LoginPolicy.selectLoginPolicyListTotCnt", loginPolicyVO);
	}
	...
	public LoginPolicyVO selectLoginPolicy(LoginPolicyVO loginPolicyVO) throws Exception {
		return (LoginPolicyVO)selectOne("LoginPolicy.selectLoginPolicy", loginPolicyVO);
	}
	...
	public void insertLoginPolicy(LoginPolicy loginPolicy) throws Exception {
        insert("LoginPolicy.insertLoginPolicy", loginPolicy);
	}
	...
	public void updateLoginPolicy(LoginPolicy loginPolicy) throws Exception {
		update("LoginPolicy.updateLoginPolicy", loginPolicy);
	}
	...
	public void deleteLoginPolicy(LoginPolicy loginPolicy) throws Exception {
		delete("LoginPolicy.deleteLoginPolicy", loginPolicy);
	}
