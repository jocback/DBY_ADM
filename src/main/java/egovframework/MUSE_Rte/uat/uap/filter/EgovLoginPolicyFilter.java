package egovframework.MUSE_Rte.uat.uap.filter;

import java.io.IOException;

import egovframework.com.cmm.EgovMessageSource;
import egovframework.MUSE_Rte.uat.uap.service.EgovLoginPolicyService;
...
public class EgovLoginPolicyFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if (id == null || userSe == null) {
			((HttpServletResponse) response).sendRedirect(httpRequest.getContextPath() + "/boffice/museAdmLogin.do");
		}
		...
		try {
			...
			((HttpServletResponse) response).sendRedirect(httpRequest.getContextPath() + "/boffice/museAdmLogin.do?login_error=1");
		}
	}
