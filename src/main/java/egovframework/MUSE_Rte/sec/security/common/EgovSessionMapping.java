package egovframework.MUSE_Rte.sec.security.common;
...
public class EgovSessionMapping extends EgovUsersByUsernameMapping {
    ...
    protected EgovUserDetails mapRow(ResultSet rs, int rownum) throws SQLException {
       ...
       // String strOrgnztId  = rs.getString("orgnzt_id");
        ...
        String strGroupLvl    = rs.getString("group_level");
        String strActGrIdx    = rs.getString("gr_idx");
        ...
        loginVO.setGroupLvl(strGroupLvl);
        loginVO.setActGrIdx(strActGrIdx);
