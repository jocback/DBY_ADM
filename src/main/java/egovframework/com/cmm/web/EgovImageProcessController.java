...
public class EgovImageProcessController extends HttpServlet {
    ...
    public void getImageInf(SessionVO sessionVO, ModelMap model, @RequestParam Map<String, Object> commandMap, HttpServletResponse response) throws Exception {
		...
		try {
			if(atchFileId == null || atchFileId.equals("") || fvo==null){
				fvo = new FileVO();
				file = new File(context.getRealPath("/images//"), "NO_IMG");
    ...
    @RequestMapping("/cmm/fms/getImageSearch.do")
    public void getImageSearch(SessionVO sessionVO, ModelMap model, @RequestParam Map<String, Object> commandMap, HttpServletResponse response) throws Exception {
		...
		FileVO fvo = new FileVO();
		if(atchFileId != null && !atchFileId.equals("")){
			fvo = fileService.selectFileSearch(vo);
		}
