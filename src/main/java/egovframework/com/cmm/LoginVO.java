...
public class LoginVO implements Serializable{
	...
	/** 권한그룹 */
	private String actGrIdx;
	/** OTP등록코드 */
	private String otpRCd;
	/**
	 * id attribute 를 리턴한다.
	 * @return String
	 */
	...
	public void setGroupLvl(String groupLvl) {
	...
	public String getActGrIdx() {
		return actGrIdx;
	}
	public void setActGrIdx(String actGrIdx) {
		this.actGrIdx = actGrIdx;
	}
	public String getOtpRCd() {
		return otpRCd;
	}
	public void setOtpRCd(String otpRCd) {
		this.otpRCd = otpRCd;
	}
