...
public class EgovCmmUseServiceImpl extends EgovAbstractServiceImpl implements EgovCmmUseService {
	...
	public String commonCodeEtc1(ComDefaultCodeVO vo) {
		return cmmUseDAO.commonCodeEtc1(vo);
	}

	@Override
	public void updateCommonCodeEtc1(CmmnDetailCode vo) throws Exception {
		cmmUseDAO.updateCommonCodeEtc1(vo);
	}
    ...
    public String selectFieldDataOne(String ta, String fi, String wh, String va) throws Exception {
    	...
    	defaultVO.setTableNm(ta);
    	defaultVO.setCodeId(fi);
    	defaultVO.setCodeEtc1(wh);
    	defaultVO.setCodeDc(va);
		return cmmUseDAO.selectFieldDataOne(defaultVO);
    }
