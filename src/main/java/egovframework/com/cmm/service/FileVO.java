...
public class FileVO implements Serializable {
   ...
   /**
    ...
    public String getThumFileSn() {
	return thumFileSn;
    }
    public void setThumFileSn(String thumFileSn) {
	this.thumFileSn = thumFileSn;
    }
